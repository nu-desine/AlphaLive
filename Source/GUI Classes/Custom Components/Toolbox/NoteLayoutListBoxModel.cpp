...
NoteLayoutListBoxModel::NoteLayoutListBoxModel(StringArray itemText)
{
    text = itemText;
}

NoteLayoutListBoxModel::~NoteLayoutListBoxModel()
{
    
}

int NoteLayoutListBoxModel::getNumRows()
{
    return text.size();
}

void NoteLayoutListBoxModel::paintListBoxItem (int rowNumber, Graphics &g, int width, int height, bool rowIsSelected)
{

...
#ifndef BINARY_BINARYDATANEW_H
#define BINARY_BINARYDATANEW_H

namespace BinaryDataNew
{
    extern const char*  autocycleicon_png;
    const int           autocycleicon_pngSize = 4169;

    extern const char*  autostartsymbol_png;
    const int           autostartsymbol_pngSize = 3113;

    extern const char*  bitcrushicon_png;
    const int           bitcrushicon_pngSize = 4325;

    extern const char*  bpficon_png;
    const int           bpficon_pngSize = 3507;

    extern const char*  ccmessageicon_png;
    const int           ccmessageicon_pngSize = 4207;

    extern const char*  channelaftertouchicon_png;
    const int           channelaftertouchicon_pngSize = 3919;

    extern const char*  controlsymbol_png;
    const int           controlsymbol_pngSize = 3671;

    extern const char*  cycleicon_png;
    const int           cycleicon_pngSize = 3819;

    extern const char*  delayicon_png;
    const int           delayicon_pngSize = 3405;

    extern const char*  exclusiveicon_png;
    const int           exclusiveicon_pngSize = 4116;

    extern const char*  expoicon_png;
    const int           expoicon_pngSize = 3980;

    extern const char*  finishicon_png;
    const int           finishicon_pngSize = 3541;

    extern const char*  flangericon_png;
    const int           flangericon_pngSize = 4304;

    extern const char*  gainicon_png;
    const int           gainicon_pngSize = 4225;

    extern const char*  hpficon_png;
    const int           hpficon_pngSize = 3308;

    extern const char*  indestructableicon_png;
    const int           indestructableicon_pngSize = 3676;

    extern const char*  interfacemain_png;
    const int           interfacemain_pngSize = 152200;

    extern const char*  inverticon_png;
    const int           inverticon_pngSize = 3454;

    extern const char*  latchicon_png;
    const int           latchicon_pngSize = 3565;

    extern const char*  linearicon_png;
    const int           linearicon_pngSize = 3897;

    extern const char*  linkicon_png;
    const int           linkicon_pngSize = 3341;

    extern const char*  loading_png;
    const int           loading_pngSize = 37784;

    extern const char*  loadsymbol_png;
    const int           loadsymbol_pngSize = 3265;

    extern const char*  logicon_png;
    const int           logicon_pngSize = 4029;
    ...
    const int           pitchbenddownicon_pngSize = 4013;

    extern const char*  pitchbendupicon_png;
    const int           pitchbendupicon_pngSize = 3980;

    extern const char*  polyphonicaftertouchicon_png;
    const int           polyphonicaftertouchicon_pngSize = 3977;

    extern const char*  pressuresettingsicon_png;
    const int           pressuresettingsicon_pngSize = 4596;

    extern const char*  quantiseicon_png;
    const int           quantiseicon_pngSize = 3654;

    extern const char*  reverbicon_png;
    const int           reverbicon_pngSize = 3385;
    ...
    extern const char*  staticicon_png;
    const int           staticicon_pngSize = 3667;

    extern const char*  statusoff_png;
    const int           statusoff_pngSize = 58008;

    extern const char*  stickyicon_png;
    const int           stickyicon_pngSize = 3256;

    extern const char*  syncicon_png;
    const int           syncicon_pngSize = 3423;
    ...
    const int           toggleicon_pngSize = 3602;

...
//==============================================================================
class AlphaAudioSettingsComponent::MidiInputSelectorComponentListBox  : public ListBox,
public ListBoxModel
{
public:
    //==============================================================================
...
//==============================================================================
AlphaAudioSettingsComponent::AlphaAudioSettingsComponent (AudioDeviceManager& deviceManager_,
...
AlphaAudioSettingsComponent::~AlphaAudioSettingsComponent()
{
    deviceManager.removeChangeListener (this);
}

void AlphaAudioSettingsComponent::resized()
{
    const int lx = proportionOfWidth (0.35f);
    const int w = proportionOfWidth (0.4f);
    const int h = 24;
...
void AlphaAudioSettingsComponent::childBoundsChanged (Component* child)
{
    if (child == audioDeviceSettingsComp)
        resized();
}

void AlphaAudioSettingsComponent::buttonClicked (Button*)
{
...
void AlphaAudioSettingsComponent::comboBoxChanged (ComboBox* comboBoxThatHasChanged)
{
...
void AlphaAudioSettingsComponent::changeListenerCallback (ChangeBroadcaster*)
{
    updateAllControls();
}

void AlphaAudioSettingsComponent::updateAllControls()
{
    if (deviceTypeDropDown != nullptr)
